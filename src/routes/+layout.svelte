...
<svelte:head>
	...
	<!-- JSON-LD structured data. Escaping < in the JSON string avoids any chance of
	     a nested </script> terminator, and the {@html `<script>...`} pattern is the
	     canonical SvelteKit way to inject a typed script tag (see Navillus, Svead). -->
